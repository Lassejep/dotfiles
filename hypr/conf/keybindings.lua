...
-- Resize tiles
hl.bind(mainMod + "CTRL + H", hl.dsp.window.resize({ -80, 0 }))
hl.bind(mainMod + "CTRL + L", hl.dsp.window.resize({ 80, 0 }))
hl.bind(mainMod + "CTRL + K", hl.dsp.window.resize({ 0, -40 }))
hl.bind(mainMod + "CTRL + J", hl.dsp.window.resize({ 0, 40 }))
